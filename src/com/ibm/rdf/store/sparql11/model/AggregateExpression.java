...
public class AggregateExpression extends Expression {
	...
	public TypeMap.TypeCategory getTypeRestriction(Variable v)
	{
		...
		// Kavitha The only functions whose arguments have to be numeric are sum and average
		switch(aggrType) {
			case SUM:
			case AVG:
	...
	{ 
		...
		switch(aggrType) {
			...
			case SUM: sb.append("SUM("); break;
			case MIN: sb.append("MIN("); break;
			case MAX: sb.append("MAX("); break;
			case AVG: sb.append("AVG("); break;
			case SAMPLE: sb.append("SAMPLE("); break;
			case GROUP_CONCAT: sb.append("GROUP_CONCAT("); break;
		}
		if (distinct) sb.append("DISTINCT ");
		if (args != null) sb.append(args.toString());
		else sb.append(" * ");
		if (!separator.equals("")) sb.append("; SEPARATOR="+separator);
		sb.append(")");
		return sb.toString(); 
	}
	...
	{ 
		...
		if (distinct) sb.append("DISTINCT ");
		if (args != null) sb.append(args.getStringWithVarName());
		else sb.append(" * ");
		if (!separator.equals("")) sb.append("; SEPARATOR="+separator);
		sb.append(")");
		return sb.toString(); 
	...
	public boolean equals(Object obj) {
		...
		if (!separator.equals(other.separator)) return false;
		return true;
	}
	...
	{
		if (args != null) args.renamePrefixes(base, declared, internal);
	}
	...
	public boolean containsCast(Variable v){
		if(args!=null)return args.containsCast(v);
		else return false;
	}
