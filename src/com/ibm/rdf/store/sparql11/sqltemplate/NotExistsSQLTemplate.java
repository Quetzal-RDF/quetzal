...
public class NotExistsSQLTemplate extends AbstractSQLTemplate {
	protected STPlanNode left;
	protected STPlanNode right;
	protected boolean isNegated;
	
	public NotExistsSQLTemplate(String templateName, STPlanNode planNode,
			Store store, Context ctx, STPlanWrapper wrapper, STPlanNode left, STPlanNode right, boolean isNegated) {
