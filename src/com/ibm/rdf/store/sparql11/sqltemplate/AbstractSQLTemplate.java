...
public abstract class AbstractSQLTemplate {
	...
	public AbstractSQLTemplate(String templateName, Store store, Context ctx, STPlanWrapper wrapper, STPlanNode planNode) {
	...
	public boolean getPredecessorConstraint(List<String> sqlConstraint,
			Variable variable, STPlanNode predecessor, String column, String typeColumn,
