...
import com.ibm.rdf.store.jena.impl.DB2Dataset;
import com.ibm.rdf.store.jena.impl.DB2Graph;
import com.ibm.rdf.store.jena.impl.DB2QueryExecutionImpl;
...
public class RdfStoreQueryExecutionFactory {
	...
	public static QueryExecution create(Query query, Model model, OWLQLSPARQLCompiler compiler) {
		...
		return new DB2QueryExecutionImpl( (com.ibm.rdf.store.jena.Query)query,
	...
	public static QueryExecution create(String sparql, Model model, OWLQLSPARQLCompiler compiler) {
		...
		return new DB2QueryExecutionImpl((com.ibm.rdf.store.jena.Query)
