...
import com.ibm.rdf.store.jena.Query;
...
import com.ibm.rdf.store.sparql11.QueryProcessorImpl;
...
public class DB2QueryExecutionImpl implements QueryExecution
   ...
   private com.ibm.rdf.store.Context getNativeContext()
      {
      ...
      com.ibm.rdf.store.Context nativeCtx = new com.ibm.rdf.store.Context();
