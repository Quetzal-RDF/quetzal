...
import com.ibm.rdf.store.jena.impl.DB2DescribeHandler;
import com.ibm.rdf.store.query.QueryProcessorFactory;
import com.ibm.rdf.store.sparql11.model.AskQuery;
import com.ibm.rdf.store.sparql11.model.BinaryUnion;
import com.ibm.rdf.store.sparql11.model.ConstructQuery;
import com.ibm.rdf.store.sparql11.model.DatasetClause;
import com.ibm.rdf.store.sparql11.model.DescribeQuery;
import com.ibm.rdf.store.sparql11.model.Expression;
import com.ibm.rdf.store.sparql11.model.Expression.EExpressionType;
import com.ibm.rdf.store.sparql11.model.GroupCondition;
import com.ibm.rdf.store.sparql11.model.HavingCondition;
import com.ibm.rdf.store.sparql11.model.IRI;
import com.ibm.rdf.store.sparql11.model.LimitOffsetClauses;
...
public class Query extends com.hp.hpl.jena.query.Query {
	...
	private com.ibm.rdf.store.sparql11.model.Query internalQ;
	...
	public Query(com.ibm.rdf.store.sparql11.model.Query db2query) {
	...
	private void doOperations(File f) {
		if (f == null) {
			if (internalQ == null) {
				internalQ =  (com.ibm.rdf.store.sparql11.model.Query) QueryProcessorFactory
					.parse(sparql);
			}
		} else {
			internalQ = (com.ibm.rdf.store.sparql11.model.Query) QueryProcessorFactory
	...
	public com.ibm.rdf.store.sparql11.model.Query getDB2Query() {
		return internalQ;
	}
