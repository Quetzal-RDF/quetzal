...
public class StoreImpl implements Store {
	...
	public static final String SharktemplatesFile = "com/ibm/rdf/store/sparql11/sqlwriter/SharkSQLTemplates.stg";
	
	public static final String DB2DatatypesFile = "com/ibm/rdf/store/runtime/service/sql/DB2.datatypes";
	public static final String PostgresqlDatatypesFile = "com/ibm/rdf/store/runtime/service/sql/Postgresql.datatypes";
	public static final String SharkDatatypesFile = "com/ibm/rdf/store/runtime/service/sql/Shark.datatypes";
	...
	public void setStoreBackend(String storeBackend) {
		...
		try {
			...
			InputStream common = SPARQLToSQLExpression.class.getClassLoader().getResourceAsStream("com/ibm/rdf/store/sparql11/sqlwriter/common.stg");
