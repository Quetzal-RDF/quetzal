      ...
      if (props == null)
         ...
         if (backend.equalsIgnoreCase(Store.Backend.postgresql.name()))
            ...
            in = props
                  ...
                  .getClassLoader()
                  .getResourceAsStream(
                        "com/ibm/rdf/store/runtime/service/sql/PostgreSQLRdfStoreSqls");
            }
            ...
            in = props
                  ...
                  .getClassLoader()
                  .getResourceAsStream(
                        "com/ibm/rdf/store/runtime/service/sql/DB2RdfStoreSqls");
            }
         else
         { 
        	 ...
        	 in = props
                     ...
                     .getClassLoader()
                     .getResourceAsStream(
                           "com/ibm/rdf/store/runtime/service/sql/Hive2RdfStoreSqls");
         }
         try
            {
            props.load(in);
