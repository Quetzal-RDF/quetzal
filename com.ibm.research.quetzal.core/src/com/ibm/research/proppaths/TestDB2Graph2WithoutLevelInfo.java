...
public class TestDB2Graph2WithoutLevelInfo {
	...
	public static String getRecursionStmt(String deltatable, String olddeltatable, boolean distinct) {
		String   Q2_STMT2 = ""
            ...
            + "  TEMP_1_0 AS\n"
            + "     (SELECT T.VAL AS VAL\n"
            + "        FROM "+ olddeltatable+" P, DB2ADMIN.DBP38EN_DPH AS D,\n"
            + "             TABLE(VALUES (D.VAL55, D.LBL55)) AS T (VAL, LBL)\n"
            + "        WHERE P.VAL = D.ENTRY AND T.LBL IN ('http://dbpedia.org/ontology/team')),\n"
            + "  TEMP_1_1 AS\n"
