...
public class SinatraTests extends TestRunner<DB2TestData> {
	...
	public void testLoansInHighUnemploymentRateAreas() {
		executeSparql(
			...
			"_:y <http://tables.sinatra.ibm.com/FIPS> ?f ; <http://tables.sinatra.ibm.com/UnemploymentRate> ?u ; <http://tables.sinatra.ibm.com/Period> ?d . " + 
			" _:x <http://tables.sinatra.ibm.com/ZipCode> ?z ; <http://tables.sinatra.ibm.com/FIPS> ?f . " + 
			"FILTER (?u > 10.0 && ?d = \"2014-10\"^^<http://www.w3.org/2001/XMLSchema#gMonthYear>) }", 496);
	}
	...
	public void testPoolBalancesInAreasWithHighUnemploymentRate() {
		executeSparql(
			...
			" ?p a <http://lewtandata.sinatra.ibm.com/type#ABSNetLoanPool> . " +
			" ?l a <http://lewtandata.sinatra.ibm.com/type#ABSNetLoan> ; " + 
	...
	public void testPoolFractionInAreasOfRisingUnemploymentRate() {
		executeSparql(
			...
			" ?p a <http://lewtandata.sinatra.ibm.com/type#ABSNetLoanPool> ; " +
			"    <http://lewtandata.sinatra.ibm.com/ABSNetPool> ?n . " +
			" ?n a <http://lewtandata.sinatra.ibm.com/type#ABSNetPool> ; " +
