...
if [[ $1 == "SESAME" ]]; then
	...
	java -Xmx32G org.junit.runner.JUnitCore com.ibm.rdf.store.sesame.SesameSP2BTest
elif [[ $1 == "RDF3X" ]]; then
	...
	java -Xmx32G org.junit.runner.JUnitCore com.ibm.rdf.store.jena.JenaSP2BTest
	...
	java -Xmx32G org.junit.runner.JUnitCore com.ibm.rdf.store.virtuoso.VirtuosoSP2BTest
fi
